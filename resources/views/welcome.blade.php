	...
	<div class="container">
	  <div class="row mb-4">
		<div class="col-lg-8 mx-auto text-center">
		  <h2 class="fs-1">Knowledge Terbaru</h2>
		  <p class="mb-0">
			Knowledge Menyediakan Jurnal, Exsum, Report dan Explanation untuk Keperluan Internal PJT I
		  </p>
		</div>
	  </div>
		  ...
		  <div class="row g-4">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
			  <div class="card shadow h-100">
				<img
				  src="{{ $know->photo ? \Storage::url($know->photo) : '' }}"
				  class="card-img-top"
				  alt="course image"
				/>
				<div class="card-body pb-0">
				  <div class="d-flex justify-content-between mb-2">
					<a
					  href="{{ route('knows-detail', ['id' => encrypt($know->id)]) }}"
					  class="badge bg-blue bg-opacity-10 text-purple"
					  >{{$know->topic->name}}</a
					>
				...
				<div class="card-footer pt-0 pb-3">
				  ...
				  <div class="d-flex justify-content-between">
					<span class="h6 fw-light mb-0"
					  ><i class="far fa-clock text-danger me-2"></i>By:{{$know->writer}}</span
					>
				  </div>
				</div>
			  </div>
