                ...
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right">
                                @lang('crud.coupons.inputs.cutprice')
                            </th>
                            <th class="text-left">
                                @lang('crud.coupons.inputs.typecut')
                            </th>
                            <th class="text-right">
                                @lang('crud.coupons.inputs.maxcut')
                            </th>
                            <th class="text-right">
                                @lang('crud.coupons.inputs.maxusage')
                            </th>
                            <th class="text-left">
                                @lang('crud.coupons.inputs.expireddate')
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $coupon->code ?? '-' }}</td>
                            <td>{{ $coupon->cutprice ?? '-' }}</td>
                            <td>{{ $coupon->typecut ?? '-' }}</td>
                            <td>{{ $coupon->maxcut ?? '-' }}</td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="7">{!! $coupons->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
