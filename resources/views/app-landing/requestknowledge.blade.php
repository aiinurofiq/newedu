                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-8 col-xl-12">
                                    <div class="card shadow">
                                        ...
                                        @else
                                            <a href="{{ route('checkout', ['id' => encrypt($knows->id)]) }}"
                                                class="btn btn-success mb-2 mb-sm-0 me-00 me-sm-3"><i
                                                    class="bi bi-cart3 me-2"></i>Request Knowldedge</a>
                                        </div>
                                        @endif
                                    </div>
                                </div>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <ul class="list-group list-group-borderless">
                                <li class="list-group-item px-0"> <span class="h6 fw-light"><i
                                        ...
                                        date:</span> <span class="h6">{{ $knows->created_at->format('d M Y') }}</span>
                                </li>
                                <li class="list-group-item px-0"> <span class="h6 fw-light"><i
                                            class="fas fa-fw fa-book text-primary me-2"></i>File count:</span> <span
                                        class="h6">{{ $total }}</span> </li>
                                <li class="list-group-item px-0"> <span class="h6 fw-light"><i
                        ...
                        <div class="col-md-6">
                            <ul class="list-group list-group-borderless">
                                <li class="list-group-item px-0"> <span class="h6 fw-light"><i
                                            class="bi fa-fw bi-person-circle text-primary me-2"></i>Writer by:</span>
                                    <span class="h6">{{ $knows->writer }}</span>
                                </li>
                                <li class="list-group-item px-0"> <span class="h6 fw-light"><i
                                            class="bi fa-fw bi-eye-fill text-primary me-2"></i>Category:</span> <span
                                        class="h6">{{ $knows->category->name }}</span> </li>
                            </ul>
                        </div>
                    </div>
                    <p>Knowldedge ini dibatasi kepada beberapa pengguna. Untuk dapat mengakses Knowldedge ini silahkan
                            ...
                            <div class="tab-pane fade show active" id="book-pills-1" role="tabpanel"
                                ...
                                <div class="row g-4">
                                    <div class="col-md-3"> <img
                                            src="{{ $knows->user->profile_photo_path ? \Storage::url($knows->user->profile_photo_path) : '' }}"
                                            class="rounded-3" alt=""> </div>
                                    <div class="col-md-9">
                                        <div class="d-sm-flex justify-content-sm-between">
                                            <div class="mb-3">
                                                <h3 class="mb-0">{{ $knows->user->name }}</h3> <span>Publisher</span>
                                            </div>
                                        </div>
                                        <P class="mt-3 mt-sm-0 mb-0">{{ $knows->user->name }} merupakan author yang
                                            mengupload Knowledge {{ $knows->title }} yang diupload pada tanggal
                                            {{ $knows->created_at->format('d F Y') }} dengan jumlah
                                            {{ $total }} File.</P>
                                    </div>
                                </div>
                            </div>
