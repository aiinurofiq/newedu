...
@section('content-landing')
    ...
    @push('script')
        <script>
            ...
            // var url = 'http://192.168.3.201/eduvi/public/storage/.pdf';
                        ...
                        switch (fileExtension) {
                            case 'png':
                                ...
                                $('#changeimage').attr("src",
                                    "http://192.168.3.201/eduvi/public/" + img);
                                break;
                            case 'jpeg':
                                $('#gambar').removeClass('d-none')
                                $('#changeimage').attr("src",
                            ...
                            case 'mp4':
                                ...
                                //     "http://192.168.3.201/eduvi/public/" + img);
                                src = "http://192.168.3.201/eduvi/public/" + img;
                                type = "video/mp4";
                                poster = "";
                                // alert(player)
                            ...
                            case 'pdf':
                                ...
                                url = "http://192.168.3.201/eduvi/public/" + img;
                                pageNum = 1;
