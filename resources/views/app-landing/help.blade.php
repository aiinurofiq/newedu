    ...
    <div class="container">
        ...
        <div class="col-lg-8 mx-auto text-center">
            ...
            <div class="col-12">
                ...
                >
                <a
                    class="btn btn-white btn-sm fw-light"
                ...
                <a
                    ...
                    href="help-center-detail.html"
                >
                    What's are the difference between a social?</a
                >
                <a class="btn btn-primary-soft btn-sm fw-light" href="#!"
                    >View all question</a
                >
                </div>
            </div>
...
<div class="container">
    ...
    <div class="col-md-6 col-xl-3">
        ...
        <div class="card-body">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex" href="help-center-detail.html">
                <i class="fas fa-angle-right text-primary pt-1 me-2"></i
    ...
    <div class="col-md-6 col-xl-3">
        ...
        <div class="card-body">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex" href="help-center-detail.html">
                <i
                    class="fas fa-angle-right text-primary pt-1 fa-fw me-2"
                ></i
                >Admin &amp; Billing
                </a>
            </li>
...
<div class="container">
    ...
    <div class="col-xl-6">
        ...
        <h4 class="card-title mb-4">
            <a href="#" class="stretched-link">The installation part</a>
        </h4>
    ...
    <div class="col-xl-6">
        ...
        <h4 class="card-title mb-4">
            ...
            >Supporting Customer With Inbox</a
            >
        </h4>
        <div class="d-sm-flex align-items-center">
            <ul class="avatar-group mb-2 mb-sm-0">
    ...
    <div class="col-xl-6">
        <div class="card card-body border p-4 h-100">
        <h4 class="card-title mb-4">
            <a href="#" class="stretched-link">Connect With Customers</a>
        </h4>
        <div class="d-sm-flex align-items-center">
            <ul class="avatar-group mb-2 mb-sm-0">
            <li class="avatar avatar-md">
