...
<div class="col-12">
    <div class="row g-4">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3">
            ...
            <img
                src="{{$learnings->image ? \Storage::url($learnings->image) : '' }}"
                class="card-img-top"
                alt="course image"
            />
            <div class="card-body pb-0">
                ...
                <a
                    ...
                    >{{$learnings->categorylearn->name}}</a
                >
                </div>
                <h5 class="card-title">
                    <a href="{{ route('learns-detail', ['id' => encrypt($learnings->id)]) }}">{{$learnings->title}}</a>
                </h5>
            ...
            <div class="card-footer pt-0 pb-3">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    ><i class="far fa-clock text-danger me-2"></i>By:{{$learnings->user->name}}</span
                  >
                </div>
            </div>
            </div>
