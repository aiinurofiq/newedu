							...
							<div class="col-sm-10 col-xl-8 m-auto"> <span class="mb-0 fs-1">👋</span>
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-lg"> <span class="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i class="bi bi-envelope-fill"></i></span>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-lg"> <span class="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i class="fas fa-lock"></i></span>
                                    ...
                                    <div class="mb-4 d-flex justify-content-between mb-4">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="exampleCheck1" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>Remember me</label>
                                        </div>
                                        @if (Route::has('password.request'))
                                            <div class="text-primary-hover">
                                                <a href="{{ route('password.request') }}" class="text-secondary"> <u>Forgot password?</u> </a>
                                            </div>
                                        @endif
                                    </div>
