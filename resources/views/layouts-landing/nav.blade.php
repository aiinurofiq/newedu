<nav class="navbar navbar-expand-xl">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}"> <img class="light-mode-item navbar-brand-item"
                src="{{ asset('assets/images/logo.png') }}" alt="logo"> <img class="dark-mode-item navbar-brand-item"
                src="{{ asset('assets/images/logo6.png') }}" alt="logo"> </a>
                ...
                <div class="nav-item w-100">
                    <ul class="navbar-nav navbar-nav-scroll mx-auto">
                        ...
                        @if (Route::has('login'))
                            ...
                            @else
                                <li class="nav-item">
                                    <a href="{{ route('login') }}" class="btn btn-primary mb-0 ml-3">Login</a>
                                </li>
                            @endauth
                        @endif
                    </ul>
                        ...
                        <div class="bg-light dark-mode-switch theme-icon-active d-flex align-items-center p-1 rounded mt-2">
                            ...
                            <button type="button" class="btn btn-sm mb-0" data-bs-theme-value="auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-circle-half fa-fw mode-switch" viewBox="0 0 16 16">
