<nav class="navbar navbar-expand-xl">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}"> <img class="light-mode-item navbar-brand-item" src="{{ asset('assets/images/logo.png') }}" alt="logo"> <img class="dark-mode-item navbar-brand-item" src="{{ asset('assets/images/logo6.png') }}" alt="logo"> </a>
                  ...
                  <div class="nav-item w-100">
                    <ul class="navbar-nav navbar-nav-scroll mx-auto">
                        <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="{{ url('/all-learning') }}">Learning</a>
                          </li>
                          @if (Route::has('login'))
                            @auth
                                <li class="nav-item">
                                    @if (auth()->user()->isSuperAdmin() || auth()->user()->isAdminUnit() )
                                    <a href="{{ url('/admin/knowledge') }}" class="btn btn-primary mb-0 ml-3"
                                    >Dashboard</a
                                    >
                                     @else
        ...
        <div class="dropdown ms-1 ms-lg-0">
            <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false"> <img class="avatar-img rounded-circle" src="{{ auth()->user()->profile_photo_path ? asset(\Storage::url(auth()->user()->profile_photo_path)) : '' }}" alt="avatar"> </a>
            <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                <li class="px-3 mb-3">
                    <div class="d-flex align-items-center">
                        <div class="avatar me-3"> <img class="avatar-img rounded-circle shadow" src="{{ auth()->user()->profile_photo_path ? asset(\Storage::url(auth()->user()->profile_photo_path)) : '' }}" alt="avatar"> </div>
