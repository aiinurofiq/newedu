...
class BloodtypeUsersController extends Controller
{
    ...
    public function store(Request $request, Bloodtype $bloodtype): UserResource
    {
        ...
        $user = $bloodtype->users()->create($validated);
