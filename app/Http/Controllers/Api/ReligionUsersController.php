...
class ReligionUsersController extends Controller
{
    public function index(Request $request, Religion $religion): UserCollection
    {
    ...
    public function store(Request $request, Religion $religion): UserResource
    {
        ...
        $user = $religion->users()->create($validated);
