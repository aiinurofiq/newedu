...
class QuizLivewire extends Component
{
    ...
    public $quizzall, $question, $answer;
    public $perPage = 5;
    public $action = 'R';
    ...
    {
        return view('livewire.admin.quizz', ['data' => $this->dataknowledge()])->layout('layouts.admin.app');
    }
    public function dataknowledge()
    {
        $cari = $this->search;
        return Learning::with('sections.quizzes')->where('hquiz', '1')->when($cari, function ($query) use ($cari) {
