...
class CategoryLivewire extends Component
{
    ...
    {
        return view('livewire.admin.category', ['data' => $this->dataknowledge()])->layout('layouts.admin.app');
    }
    public function dataknowledge()
    {
        $cari = $this->search;
        return Category::when($cari, function ($query) use ($cari) {
    ...
    public function edit($id, $confirm = false)
    {
        if (!$this->editknowledge) {
            $this->editknowledge = Category::find($id);
            ...
            if (!$confirm) {
                ...
                try {
                    ...
                    Category::where('id', $this->editknowledge->id)->update($data);
